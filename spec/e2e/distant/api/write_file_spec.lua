...
describe('distant.api.write_file', function()
    --- @type spec.e2e.Driver, spec.e2e.RemoteDir
    local driver, root

    before_each(function()
        driver = Driver:setup({ label = 'distant.api.write_file' })
    ...
    describe('synchronous', function()
        it('should create file with given text if it does not exist', function()
            ...
            local err = plugin.api.write_file({ path = file:path(), data = tobytes('some text') })
    ...
    describe('asynchronous', function()
        it('should create file with given text if it does not exist', function()
            ...
            plugin.api.write_file({ path = file:path(), data = tobytes('some text') }, capture)
