...
ARG distant_release=https://github.com/chipsenkbeil/distant/releases/download/v0.15.0-alpha.11
...
# Move our lua module to the right location
RUN mv distant_lua.so app/lua/distant_lua.so
